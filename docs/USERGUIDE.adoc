...
[source, bash]
----
iptables -A PREROUTING -t nat -p tcp -d 10.1.10.201 --dport 5001 -m statistic --mode random --probability 0.5 -j DNAT --to-destination 10.1.20.203:5001
iptables -A PREROUTING -t nat -p tcp -d 10.1.10.201 --dport 5001 -j DNAT --to-destination 10.1.20.204:5001
